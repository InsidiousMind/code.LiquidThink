    ...
    a.expr[":"].notmdproc = function(b) {
        ...
        input: function(b) {
            a(b ? b : this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function() {
                ...
                0 === c.length && (b.wrap("<div class='form-group'></div>"), c = b.closest(".form-group")), 
                ...
                c.append("<span class='material-input'></span>"), c.find("input[type=file]").length > 0 && c.addClass("is-fileinput");
            });
        },
        attachInputEventHandlers: function() {
            ...
            a(document).on("change", ".checkbox input[type=checkbox]", function() {
                ...
                a.each(this.files, function(a, b) {
                    d += b.name + ", ";
                }), d = d.substring(0, d.length - 2), d ? c.removeClass("is-empty") : c.addClass("is-empty"), 
